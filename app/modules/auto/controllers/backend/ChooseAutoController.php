 ...
 */
class ChooseAutoController extends \app\components\BaseBackendController
{
    /**
     * @var [] данные для вывода ключ - идентификатор, значение - подпись
     */
    protected $data = [];

    /**
     * @var string идентификатор родителя: mark, model, serie
     */
    protected $parentIdent = '';

    /**
     * @var string префикс для названий: марка, модель и т.д.
     */
